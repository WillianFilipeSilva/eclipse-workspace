			...
			<form action="cadastro-comunidade" method="post">
				<div class="formulario-entradas">
					<div class="foto-perfil">
						<label for="foto-enviar" class="foto-label"> <img src="" alt="Enviar Foto" class="icone-camera" id="foto-perfil"></label> 
						<input type="file" id="foto-enviar" class="foto-input" accept="image/*">
					</div>

					<div class="formulario-grupo">
						<label for="comunidade-nome">Comunidade</label> 
						<input type="text"id="comunidade-nome" class="formulario-controle" placeholder="Escreva o nome da comunidade..." maxlength="30" required>
					</div>
					...
					<div class="formulario-grupo">
						...
						<select id="localidade" class="formulario-controle" required>
