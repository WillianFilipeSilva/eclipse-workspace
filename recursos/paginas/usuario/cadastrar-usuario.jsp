...
<head>
	...
	<title>AvisaAí - Cadastrar-se</title>
...
<body>
	<header>
		<div class="logo-acesso">
			<a href="<%= request.getContextPath() %>/landing-Page"><img src="" alt="AvisaAí Logo" class="logo-avisaai"></a>
		</div>
	</header>
	<main>
				...
				<div class="formulario-entradas">
					...
					<form action="cadastro-usuario" method="post">
						...
						<div class= "formulario-botoes">
							<div class="botao-login">Já faz parte? <a href="<%= request.getContextPath() %>/login" class="link">Entrar</a></div>
